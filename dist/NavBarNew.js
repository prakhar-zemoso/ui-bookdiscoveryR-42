...
export default function NavBarNew(props) {
  ...
  return /*#__PURE__*/React.createElement(Flex, _extends({
  ...
  }, rest, getOverrideProps(overrides, "NavBarNew")), /*#__PURE__*/React.createElement(Flex, _extends({
    gap: "10px",
    direction: "row",
    width: "fit-content",
    justifyContent: "center",
  ...
  }, getOverrideProps(overrides, "logo")), /*#__PURE__*/React.createElement(View, _extends({
    width: "24px",
    height: "24px",
    shrink: "0",
    overflow: "hidden",
    position: "relative",
    padding: "0px 0px 0px 0px"
  }, getOverrideProps(overrides, "auto_stories_black_24dp 1")), /*#__PURE__*/React.createElement(View, _extends({
    padding: "0px 0px 0px 0px",
    position: "absolute",
    top: "0%",
    bottom: "0%",
    left: "0%",
    right: "0%"
  }, getOverrideProps(overrides, "Group26854")), /*#__PURE__*/React.createElement(Icon, _extends({
    width: "24px",
    height: "24px",
    viewBox: {
      minX: 0,
    ...
    left: "0%",
    right: "0%"
  }, getOverrideProps(overrides, "Vector26855")))), /*#__PURE__*/React.createElement(View, _extends({
    padding: "0px 0px 0px 0px",
    position: "absolute",
    top: "5.02%",
    bottom: "9.55%",
    left: "4.17%",
    right: "-4.17%"
  }, getOverrideProps(overrides, "Group26856")), /*#__PURE__*/React.createElement(Icon, _extends({
    width: "24px",
    ...
    left: "0%",
    right: "0%"
  }, getOverrideProps(overrides, "Vector26857"))))), /*#__PURE__*/React.createElement(Flex, _extends({
    gap: "10px",
    direction: "row",
    width: "fit-content",
    ...
    whiteSpace: "pre-wrap",
    children: "BOOK - ISTA"
  }, getOverrideProps(overrides, "BOOK - ISTA"))))), /*#__PURE__*/React.createElement(Flex, _extends({
    gap: "12px",
    direction: "row",
    width: "fit-content",
    alignItems: "flex-start",
    ...
    position: "relative",
    padding: "0px 0px 0px 0px"
  }, getOverrideProps(overrides, "NavbarTabs")), /*#__PURE__*/React.createElement(Button, _extends({
    display: "flex",
    direction: "row",
    width: "fit-content",
    justifyContent: "center",
    ...
    position: "relative",
    padding: "0px 0px 0px 0px"
  }, getOverrideProps(overrides, "Icons")), /*#__PURE__*/React.createElement(View, _extends({
    width: "24px",
    height: "24px",
    shrink: "0",
    overflow: "hidden",
    ...
    left: "16.67%",
    right: "16.67%"
  }, getOverrideProps(overrides, "Vector26831")))), /*#__PURE__*/React.createElement(Image, _extends({
    width: "45px",
    height: "45px",
    shrink: "0",
    position: "relative",
