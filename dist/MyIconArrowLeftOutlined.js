...
export default function MyIconArrowLeftOutlined(props) {
  const {
    overrides,
    ...rest
  } = props;
  ...
  }, rest, getOverrideProps(overrides, "MyIconArrowLeftOutlined")), /*#__PURE__*/React.createElement(Icon, _extends({
    width: "4px",
    height: "8px",
    viewBox: {
      minX: 0,
