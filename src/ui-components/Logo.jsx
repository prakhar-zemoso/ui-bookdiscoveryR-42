    ...
    >
      ...
      >
        <View
          ...
          left="0%"
          right="0%"
          {...getOverrideProps(overrides, "Group15897")}
        >
          <Icon
            width="24px"
            height="24px"
            ...
            left="0%"
            right="0%"
            {...getOverrideProps(overrides, "Vector15898")}
          ></Icon>
        </View>
        <View
          padding="0px 0px 0px 0px"
          ...
          left="4.17%"
          right="-4.17%"
          {...getOverrideProps(overrides, "Group15899")}
        >
          <Icon
            width="24px"
            ...
            left="0%"
            right="0%"
            {...getOverrideProps(overrides, "Vector15900")}
          ></Icon>
        </View>
      </View>
      <Flex
