    ...
    >
      ...
      >
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame13682")}
        >
          <Flex
            gap="16px"
            direction="row"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame13683")}
          >
            <Flex
              gap="16px"
              direction="row"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame13684")}
            >
              <Text
                fontFamily="Inter"
                fontSize="16px"
            ...
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame13688")}
            >
              <MyIconmorehoriz
                width="24px"
                height="24px"
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Share13691")}
      >
        <Flex
          gap="16px"
          direction="row"
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Share13692")}
        >
          <MyIconreply
            width="24px"
            height="24px"
          ...
          <Text
            ...
            whiteSpace="pre-wrap"
            children="99"
            {...getOverrideProps(overrides, "9913694")}
          ></Text>
        </Flex>
        <Flex
          gap="16px"
        ...
        >
          ...
          <Text
            ...
            whiteSpace="pre-wrap"
            children="99"
            {...getOverrideProps(overrides, "9913697")}
          ></Text>
        </Flex>
        <Flex
          gap="16px"
        ...
        >
          ...
          <Text
            ...
            whiteSpace="pre-wrap"
            children="99"
            {...getOverrideProps(overrides, "9913700")}
          ></Text>
        </Flex>
        <MyIconshare
          width="24px"
