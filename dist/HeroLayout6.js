...
export default function HeroLayout6(props) {
  ...
  }, rest, getOverrideProps(overrides, "HeroLayout6")), /*#__PURE__*/React.createElement(Flex, _extends({
    gap: "10px",
    position: "absolute",
    top: "0%",
    bottom: "0%",
  ...
  }, getOverrideProps(overrides, "HeroLayout3")), /*#__PURE__*/React.createElement(Flex, _extends({
    gap: "40px",
    direction: "column",
    height: "168px",
  ...
  }, getOverrideProps(overrides, "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.")))), /*#__PURE__*/React.createElement(Button, _extends({
    display: "flex",
    gap: "0",
    direction: "row",
    width: "fit-content",
  ...
  }, getOverrideProps(overrides, "Button"))))), /*#__PURE__*/React.createElement(Image, _extends({
    position: "absolute",
    top: "0%",
    bottom: "0%",
    height: "100%",
