...
export default function MyIconrecenttitles(props) {
  const {
    overrides,
    ...rest
  } = props;
  return /*#__PURE__*/React.createElement(Flex, _extends({
  ...
  }, rest, getOverrideProps(overrides, "MyIconrecenttitles")), /*#__PURE__*/React.createElement(View, _extends({
    width: "24px",
    height: "24px",
    shrink: "0",
    overflow: "hidden",
    position: "relative",
    padding: "0px 0px 0px 0px"
  }, getOverrideProps(overrides, "subtitles_black_24dp 1")), /*#__PURE__*/React.createElement(Icon, _extends({
    width: "20px",
    height: "16px",
    viewBox: {
      minX: 0,
