...
export default function HeroCrad60(props) {
  ...
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "HeroCrad60")}
    >
      <Image
        width="184px"
        height="239px"
      ...
      >
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Author53426")}
        >
          <Icon
            width="32px"
            height="32px"
          ...
          >
            <Text
              ...
              whiteSpace="pre-wrap"
              children="J D Lee"
              {...getOverrideProps(overrides, "J D Lee")}
            ></Text>
            <Text
              fontFamily="Roboto"
              fontSize="12px"
              ...
              whiteSpace="pre-wrap"
              children="Author"
              {...getOverrideProps(overrides, "Author53406")}
            ></Text>
          </Flex>
        </Flex>
        <MyIconmorehoriz
      ...
      <Flex
        ...
        alignItems="flex-end"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Icons_Ratings")}
      >
        <Flex
          gap="4px"
          direction="column"
        ...
        >
          ...
          <Text
            ...
            {...getOverrideProps(overrides, "830 ratings")}
          ></Text>
        </Flex>
        <Flex
          gap="12px"
