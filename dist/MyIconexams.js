...
export default function MyIconexams(props) {
  const {
    overrides,
    ...rest
  } = props;
  ...
  }, rest, getOverrideProps(overrides, "MyIconexams")), /*#__PURE__*/React.createElement(Flex, _extends({
