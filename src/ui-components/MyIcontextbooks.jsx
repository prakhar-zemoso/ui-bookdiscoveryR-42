...
export default function MyIcontextbooks(props) {
  ...
  return (
    <Flex
      ...
      {...rest}
      {...getOverrideProps(overrides, "MyIcontextbooks")}
    >
      <Flex
      ...
      >
        <Icon
          ...
          left="0%"
          right="82.18%"
          {...getOverrideProps(overrides, "Vector124564")}
        ></Icon>
        <Icon
          ...
          left="20.21%"
          right="62.16%"
          {...getOverrideProps(overrides, "Vector124565")}
        ></Icon>
        <Icon
          width="2.46826171875px"
          ...
          left="40.05%"
          right="42.32%"
          {...getOverrideProps(overrides, "Vector124566")}
        ></Icon>
        <Icon
