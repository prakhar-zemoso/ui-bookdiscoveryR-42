  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            <MyIconarrowright
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "MyIcon/arrow-right13664")}
            ></MyIconarrowright>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Share13666")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="Share"
              {...getOverrideProps(overrides, "Share13667")}
            ></Text>
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Read more13672")}
      >
        <MyIconarrowright
          width="24px"
          height="24px"
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "MyIcon/arrow-right13673")}
        ></MyIconarrowright>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Read more"
          {...getOverrideProps(overrides, "Read more13674")}
        ></Text>
      </Flex>
    </Flex>
  );
