...
export default function HeroCard70(props) {
  ...
  return (
    <Flex
      ...
      {...rest}
      {...getOverrideProps(overrides, "HeroCard70")}
    >
      <Image
        width="276px"
        height="301px"
      ...
      >
        ...
        >
          <Text
            ...
            {...getOverrideProps(overrides, "Concise Inorganic Chemistry")}
          ></Text>
          <Text
            fontFamily="Roboto"
            fontSize="14px"
          ...
          <Text
            ...
            {...getOverrideProps(overrides, "Language: English")}
          ></Text>
        </Flex>
        <Flex
          gap="16px"
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Button_icons")}
        >
          <Button
            display="flex"
            gap="0"
