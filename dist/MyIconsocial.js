...
export default function MyIconsocial(props) {
  const {
    overrides,
    ...rest
  } = props;
  ...
  }, rest, getOverrideProps(overrides, "MyIconsocial")), /*#__PURE__*/React.createElement(Flex, _extends({
